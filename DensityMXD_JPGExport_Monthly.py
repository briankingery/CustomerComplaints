...
env.workspace = r"R:\Divisions\Distribution\Shared\TechnicalScvs\ProjectFiles\EngProjects\Customer_Complaints\Density_Monthly.gdb"
env.overwriteOutput = True

mxd = arcpy.mapping.MapDocument("R:/Divisions/Distribution/Shared/TechnicalScvs/ProjectFiles/EngProjects/Customer_Complaints/Density_Monthly.mxd")
...
for df in arcpy.mapping.ListDataFrames(mxd):
    ...
    for raster in arcpy.ListRasters("D*"):              # List all rasters that start with a 'D'
        ...
        for target in targetGroupLayer:
            ...
            jpg = "R:/Divisions/Distribution/Shared/TechnicalScvs/ProjectFiles/EngProjects/Customer_Complaints/Density_JPGs_Monthly/" + raster + ".jpg"
